 ...
 *
 * <b>spring初始化:</b>
 * &lt;bean class="cn.org.rapid_framework.utils.holder.PropertiesHolder">
...
public class PropertiesHolder implements InitializingBean {
    ...
    /**
     * 显示从配置文件中读取的内容，方便检查配置参数的加载情况
     */
    private void showPropsValue() {
        Map props = PropertiesHolder.getProperies();
        for (Object key : props.keySet()) {
            log.info("config prop:" + key + "|" + props.get(key));
        }
    }
