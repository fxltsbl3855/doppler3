...
public class PropertiesHelper {
    ...
    public PropertiesHelper(Properties p, int systemPropertiesMode) {
        ...
        if (systemPropertiesMode != SYSTEM_PROPERTIES_MODE_NEVER && systemPropertiesMode != SYSTEM_PROPERTIES_MODE_FALLBACK
            ...
            throw new RuntimeException(new Throwable("error systemPropertiesMode mode:" + systemPropertiesMode));
        }
    ...
    public void setProperties(Properties props) {
        if (props == null)
            throw new RuntimeException(new Throwable("properties must be not null"));
    ...
    public String getRequiredProperty(String key) throws IllegalStateException {
        ...
        if (isBlankString(value)) {
            ...
            throw new RuntimeException(new Throwable("required property is blank by key=" + key));
        }
        return value;
    }
    ...
    public URL getURL(String key) throws IllegalArgumentException {
        try {
            ...
            throw new RuntimeException(new Throwable("Property " + key + " must be a valid URL (" + getProperty(key) + ")"));
        }
    }
    ...
    public Object getClassInstance(String key) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new RuntimeException(new Throwable(s + ": invalid class name for key " + key, nfe));
        } catch (InstantiationException e) {
            //throw new IllegalArgumentException(s + ": class could not be reflected " + s, e);
            throw new RuntimeException(new Throwable(s + ": class could not be reflected " + s, e));
    ...
    public Properties getStartsWithProperties(String prefix) {
        if (prefix == null) {
            ...
            throw new RuntimeException(new Throwable("'prefix' must be not null"));
        }
    ...
    public static Properties restoreFromString(String str) {
        ...
        try {
            ...
            throw new RuntimeException(new Throwable("restore properties from String occer error. str:" + str, e));
        }
        return p;
    }
